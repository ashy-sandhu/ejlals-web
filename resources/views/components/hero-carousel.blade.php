...
<div x-data="{ 
    ...
    x-init="autoPlay()"
    class="relative w-full h-[calc(100vh-80px)] flex flex-col bg-[#f5f8f8] overflow-hidden group border-b border-brand-teal/5">
    ...
    <div class="carousel-track w-[400%]"
        ...
        <main class="w-1/4 shrink-0 relative flex flex-col px-6 lg:px-20 py-4 pb-24">
            <div class="flex-1 flex items-center">
                <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
                    <div class="flex flex-col gap-8 z-10 w-full">
                        ...
                        <div class="space-y-4">
                            <h1 class="text-slate-900 text-4xl font-black leading-[1.05] md:text-5xl lg:text-6xl tracking-tight">
            ...
            <!-- Slide 1 Cards -->
            <div class="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div class="p-6 rounded-2xl border border-brand-teal/5 bg-white shadow-sm hover:border-brand-gold/30 hover:shadow-xl transition-all group flex items-start gap-4">
        ...
        <main class="w-1/4 shrink-0 relative flex flex-col px-6 lg:px-20 py-4 pb-24">
            <div class="flex-1 flex items-center">
                <div class="max-w-7xl mx-auto flex flex-col-reverse gap-10 lg:flex-row lg:items-center lg:gap-16 w-full">
                    ...
                    <div class="flex-1 relative w-full lg:max-w-none max-w-lg mx-auto">
                        <div class="relative z-10 w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl shadow-brand-teal/5 border-[12px] border-white">
            ...
            <!-- Slide 2 Cards -->
            <div class="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div class="group bg-white p-6 rounded-2xl border border-brand-teal/5 shadow-sm hover:shadow-xl hover:border-brand-gold/30 transition-all flex items-start gap-4">
        ...
        <main class="w-1/4 shrink-0 relative flex flex-col px-6 lg:px-20 py-4 pb-24">
            <div class="flex-1 flex items-center">
                <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
                    <div class="flex flex-col gap-8 order-2 lg:order-1">
                        ...
                        <div class="space-y-4">
                            <h1 class="text-slate-900 text-4xl md:text-5xl lg:text-6xl font-black leading-[1.05] tracking-tight">
                    ...
                    <div class="relative order-1 lg:order-2 w-full max-w-lg mx-auto lg:max-w-none">
                        <div class="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden aspect-[4/3] flex flex-col relative z-10">
            ...
            <!-- Slide 3 Cards -->
            <div class="max-w-7xl mx-auto w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
                <div class="group p-4 rounded-xl border border-brand-teal/5 bg-white shadow-sm hover:border-brand-gold/30 hover:shadow-xl transition-all flex flex-col gap-3">
                    <div class="size-10 flex items-center justify-center rounded-lg bg-brand-teal/5 text-brand-teal group-hover:bg-brand-gold group-hover:text-white transition-all">
                        <span class="material-symbols-outlined">menu_book</span>
                    </div>
                    <div>
                        <h3 class="text-slate-900 text-sm font-bold">Quranic Studies</h3>
                ...
                <div class="group p-4 rounded-xl border border-brand-teal/5 bg-white shadow-sm hover:border-brand-gold/30 hover:shadow-xl transition-all flex flex-col gap-3">
                    ...
                    <div>
                        <h3 class="text-slate-900 text-sm font-bold">Hadith & Sunnah</h3>
                ...
                <div class="group p-4 rounded-xl border border-brand-teal/5 bg-white shadow-sm hover:border-brand-gold/30 hover:shadow-xl transition-all flex flex-col gap-3">
                    ...
                    <div>
                        <h3 class="text-slate-900 text-sm font-bold">Fiqh Jurisprudence</h3>
                ...
                <div class="group p-4 rounded-xl border border-brand-teal/5 bg-white shadow-sm hover:border-brand-gold/30 hover:shadow-xl transition-all flex flex-col gap-3">
                    ...
                    <div>
                        <h3 class="text-slate-900 text-sm font-bold">Islamic History</h3>
            ...
            <div class="flex-1 flex items-center">
                <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
                    <div class="flex flex-col gap-8">
                        ...
                        <div class="space-y-4">
                            <h2 class="text-slate-900 text-4xl font-black leading-[1.05] md:text-5xl lg:text-6xl tracking-tight">
                                Empowering Modern Minds with <span class="text-brand-teal">Timeless Islamic</span> Knowledge
                            </h2>
                        </div>
                    </div>
    ...
    <div class="absolute bottom-4 left-0 right-0 z-40 px-6 pointer-events-none">
        <div class="max-w-7xl mx-auto flex items-center justify-between pointer-events-auto">
            ...
            <div class="flex items-center gap-3 hidden sm:flex">
                <button @click="prev()" class="size-10 rounded-full border border-brand-teal/10 bg-white/80 backdrop-blur-sm flex items-center justify-center text-brand-teal hover:bg-brand-gold hover:text-white hover:border-brand-gold transition-all duration-300 shadow-sm active:scale-90">
                    <span class="material-symbols-outlined">chevron_left</span>
                </button>
                <button @click="next()" class="size-10 rounded-full border border-brand-teal/10 bg-white/80 backdrop-blur-sm flex items-center justify-center text-brand-teal hover:bg-brand-gold hover:text-white hover:border-brand-gold transition-all duration-300 shadow-sm active:scale-90">
